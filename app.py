...
with st.sidebar:
    ...
    st.markdown('''Les différents vecteurs propres influent sur des paramètres différents des images générées''')
...
with col2:
    if res_init.status_code == 200:
        ...
        st.image(res_init.content, caption="Image générée par l'AI ☝️")
    else:
